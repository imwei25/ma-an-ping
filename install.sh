...
# No router: skills self-trigger by their SKILL.md descriptions. AGENTS.md / CLAUDE.md at
# the project root are plain project notes, not a routing supervisor.
set -uo pipefail
...
echo "No router: skills self-trigger by their SKILL.md descriptions. AGENTS.md / CLAUDE.md at the project root are plain project notes, not a routing supervisor."
