<#
  ...
  - No router: skills self-trigger by their SKILL.md descriptions. AGENTS.md / CLAUDE.md
    at the project root are plain project notes, not a routing supervisor.
...
Write-Host "No router: skills self-trigger by their SKILL.md descriptions. AGENTS.md / CLAUDE.md at the project root are plain project notes, not a routing supervisor."
if (-not $WithPdf) { Write-Host "Want PDF typesetting tools (pandoc + MiKTeX)? re-run with -WithPdf." -ForegroundColor DarkGray }
